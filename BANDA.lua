...
sudo_users = {SUDO,1774315810,1777864253,1535317163}   
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qwressv/150=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
' }\n'..' 𖢵  الرفع  ↚ { '..setadd..
' }\n'..' 𖢵  الحظر  ↚ { '..banm..' }\n\n 𖢵𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐\n 𖢵 قناة سورس سـبــيد↓\n [ ❲[𝐒ΘΘ𝐍](t.me/sourceSpeed)❳](t.me/sourceSpeed) \n'
send(msg.chat_id_, msg.id_,text)     
end
