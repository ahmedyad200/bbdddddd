...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/tajatsje/SAIDI/main/File_Bot/commands.lua") 
...
local bl = '›'
local keyboard = {
{'قـسـم مــطورين الـسـورس 𖢵'},
{'أسـعار الـتـنـصــيب'},
{'أسـعار السـورسات بي كامل الحـقوق'},
{'قـسم الالـعـاب'},
{'قـسم ممـيزات php'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'سـبــيد') 
local BANDA_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
┌ سعر التنصيب علي سورس سـبــيد
├ سعر التنصيب العادي 25ح
└ تواصل مع المطورين لتنصيب
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴅᴇᴍᴏɴ ϟ˼',url="t.me/XxD_E_M_O_NxX"},{text = '˹ᴅᴇʟᴀʀ ⌁ ˼', url="t.me/DeLaRALRsHaSH"}},
{{text = '˹ᴛᴏ⌁ᴀѕᴋ˼',url="t.me/sourceSpeed"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
├ السورسات بتبدا من100ي 240ج
├ سعر المصنع200
└ سعر السيرفر ،100,و 4 بي120, 8بي160
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹الــمــبــرمــج أوسسكاار الـتونز˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹تــواصــل أوسـسكار الـتونز˼',url="t.me/Soon_ban"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
os.execute('wget https://raw.githubusercontent.com/tajatsje/SAIDI/main/BANDA.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qwressv/150&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 𖢵 اصدار سورس سـبــيد{ S:12✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/Xx_SPEED_xX1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local Text = [[ 
[قناه سورس سـبــيد ادخل وتابع الجديد](t.me/sourceSpeed)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 𖢵 من أحسن السورسات على التليجرام سورس سـبــيد 𖢵
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "سـبــيد")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴅᴇᴍᴏɴ ϟ˼',url="t.me/XxD_E_M_O_NxX"},{text = '˹ᴅᴇʟᴀʀ ま˼', url="t.me/DeLaRALRsHaSH"}},
{{text = '˹ᴛᴀʜᴀ ⌁ ᴏsᴋᴀʀ ˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹ᴊᴏɪɴ⌁ѕᴘᴇᴇᴅ˼', url="t.me/sourceSpeed"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
...
{{text = '˹ᴅᴇᴍᴏɴ ϟ˼',url="t.me/XxD_E_M_O_NxX"},{text = '˹ᴅᴇʟᴀʀ ま˼', url="t.me/DeLaRALRsHaSH"}},
{{text = '˹ᴛᴀʜᴀ ⌁ ᴏsᴋᴀʀ ˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹ᴛᴏ⌁ᴀѕᴋ˼',url="t.me/XxD_E_M_O_NxX_bot"}}, 
{{text = '˹ᴊᴏɪɴ⌁ѕᴘᴇᴇᴅ˼', url="t.me/sourceSpeed"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == 'طه' or text == 'Taha' or text == 'banda' then
local Text = [[
المبرمج اوسكار التونز لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴅᴇᴍᴏɴ ϟ˼',url="t.me/XxD_E_M_O_NxX"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴅᴇʟᴀʀ ま˼',url="t.me/DeLaRALRsHaSH"}},
}
local msg_id = msg.id_/2097152/0.5
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس سـبــيد؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس سـبــيد؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[ 
 𖢵من أحسن السورسات على التليجرام سورس سـبــيد 𖢵
بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
خش على تواصل هيدخلك لروم التواصل 
]]
...
if text == 'العاب سـبــيد' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖢵 اهلا في قائمه الالعاب المتطوره سورس سـبــيد 𖢵 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/tajatsje/photo/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 𖢵 اهلا بك في متجر ملفات سـبــيد\n 𖢵 ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/tajatsje/photo/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BANDA.lua')  
else
send(msg.chat_id_, msg.id_," 𖢵 عذرا الملف لايدعم سورس سـبــيد\n") 
end
return false
end
...
if text == ("مسح قائمه سـبــيد") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖢵 تم مسح قائمه سـبــيد')
return false
end

if text == 'قائمه سـبــيد' and Sudo(msg) then
...
if #list == 0 then
t = " 𖢵 لا يوجد احد في قائمه سـبــيد"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع سـبــيد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سـبــيد@(.*)$") and Sudo(msg) then
local username = text:match("^رفع سـبــيد@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سـبــيد(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سـبــيد(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل سـبــيد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سـبــيد@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سـبــيد@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سـبــيد(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سـبــيد(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'𖣘لا يوجد رابط ارسل ضع رابط') 
end 
end,nil) 
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سـبــيد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سـبــيد')
local BANDA_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس سـبــيديعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سـبــيد').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_,' 𖣘الايدي غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'𖣘الايدي ↭ 「'..iduser..'」\n𖣘المعرف ↭ 「'..username..'」\n𖣘الرتبه ↭ 「'..rtp..'」\n𖣘نوع الكشف ↭ بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,'𖣘المعرف غير صحيح')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
{
{text = '˹𝐣𝐨𝐢𝐧⌁ѕᴘᴇᴇᴅ˼', url="t.me/sourceSpeed"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Teext =[[
𖣘أنت الآن في العاب السورس𖣘
اتبع الازار الي في الاسفل⇣
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/sourceSpeed/5"},{text = 'لعبه الرياضيات',url="https://t.me/sourceSpeed/6"}},   
{{text = 'لعبه المختلف', url="https://t.me/sourceSpeed/15"},{text = 'لعبه السمايلات', url="https://t.me/sourceSpeed/8"}}, 
{{text = 'لعبه التخمين', url="https://t.me/sourceSpeed/10"},{text = 'لعبه العكس', url="https://t.me/sourceSpeed/11"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/sourceSpeed/12"},{text = 'لعبه الانكليزي', url="https://t.me/sourceSpeed/13"}}, 
{{text = 'لعبه حزوره', url="https://t.me/sourceSpeed/9"},{text = 'لعبه المعاني', url="https://t.me/sourceSpeed/14"}}, 
{{text = 'لعبه الامثله', url="https://t.me/sourceSpeed/7"},{text = 'عقاب', url="https://t.me/sourceSpeed/30"}},
{{text = 'مريم', url="https://t.me/sourceSpeed/35"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '˹ᴊᴏɪɴ⌁ѕᴘᴇᴇᴅ˼', url="t.me/sourceSpeed"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Teext =[[
𖣘بك في مميزات سورس سـبــيد𖣘
𖣘مميزات الخاصه بسورس𖣘
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="t.me/sourceSpeed"},{text = 'كتبات',url="https://t.me/sourceSpeed/21"}},   
{{text = 'انصحني', url="t.me/sourceSpeed"},{text = 'لو خيروك', url="https://t.me/sourceSpeed/18"}}, 
{{text = 'الصراحه', url="t.me/sourceSpeed"},{text = 'حروف', url="https://t.me/sourceSpeed/19"}}, 
{{text = 'رزله', url="t.me/sourceSpeed"},{text = 'رد عليه يابوت', url="https://t.me/sourceSpeed/26"}}, 
{{text = 'بتكره دا', url="t.me/sourceSpeed"},{text = 'نكته', url="https://t.me/sourceSpeed/20"}}, 
{{text = 'غنيلي', url="t.me/sourceSpeed"}},
{{text = 'نسبه جمالي', url="t.me/sourceSpeed"},{text = 'اليتيوب', url="https://t.me/sourceSpeed/29"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '˹ᴊᴏɪɴ⌁ѕᴘᴇᴇᴅ˼', url="t.me/sourceSpeed"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سـبــيد')
