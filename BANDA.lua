...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐 𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐"
...
sudo_users = {SUDO,1774315810,1777864253,1773380350}   
...
var = true 
elseif tonumber(user_id) == tonumber(1773380350) then
var = true  
elseif tonumber(user_id) == tonumber(1777864253) then
var = true  
...
local UserName = (data.username_ or "sourceSpeed")
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'سـبيد') 
local BANDA_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
┌ سعر التنصيب علي سورس سـبيد
├ سعر التنصيب العادي 25ح
└ تواصل مع المطورين لتنصيب
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴅᴇʟᴀʀ ⌁ ѕᴘᴇᴇᴅ˼',url="t.me/DeLaRALRsHaSH"},{text = '˹ᴛᴀʜᴀ⌁ᴏғғʟɪɴᴇ˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹ᴛᴏ⌁ᴀѕᴋ˼',url="t.me/Twasl_SPEED"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = ' 𖢵 تم ارسال الملصق من ↓\n - '..Name
...
local Text = ' 𖢵 المستخدم ↚ 「'..Name..'」\n 𖢵 تم حظره من التواصل'
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qwressv/151&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 𖢵  اصدار سورس سـبيد{ S:12✓}')
end
...
local Text = [[ 
[قناه سورس سـبيد ادخل وتابع الجديد](t.me/sourceSpeed)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹ᴊᴏɪɴ⌁ѕᴘᴇᴇᴅ˼', url="t.me/sourceSpeed"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qwressv/151&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/sourceSpeed)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/sourceSpeed"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 𖢵  من أحسن السورسات على التليجرام سورس سـبيد 𖢵 
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "سـبيد")
...
send(msg.chat_id_,0," 𖢵  الـعـضو  : {["..data.first_name_.."](T.ME/sourceSpeed)}\n 𖢵  ["..BANDA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖢵  عذرا  ↚ {["..data.first_name_.."](T.ME/sourceSpeed)}\n 𖢵  عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local NameChat = NameChat:gsub("{","")  
local NameChat = NameChat:gsub("}","")  
sendText(msg.chat_id_,"𖢵 تم طرد البوت من جروب \n\n𖢵 بواسطة  {"..Name.."}\n𖢵 اسم الجروب {"..NameChat.."}\n𖢵 ايدي الجروب {"..msg.chat_id_.."} ",0,'md')  
end,nil) 
end,nil) 
end
-------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖢵 عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 𖢵 عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
'\n 𖢵 بواسطة {「'..Name..'」}'..
'\n 𖢵 ايدي الجروب {'..IdChat..'}'..
'\n 𖢵 اسم الجروب {['..NameChat..']}'..
'\n 𖢵 عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖢵 الرابط {['..LinkGp..']}'
if not DevSoFi(msg) then
sendText(SUDO,Text,0,'md')
end
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖢵 تـم تـشغـيل الـبوت فـي الـجـروب ')
else
sendText(msg.chat_id_,'\n 𖢵  مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖢵 تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
local Text = [[
╔━━━━━━━━ 𖣘 ━━━━━━━╗  
┇⦑[ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ѕᴘᴇᴇᴅ](t.me/sourceSpeed)⦒
┇⦑[ᴛʜᴇ ʙᴇѕᴛ ѕᴏụʀᴄᴇ ɪɴ ᴛᴇʟᴇ](t.me/sourceSpeed)⦒
┇⦑[ᴠᴇʀʏ ᴘʀᴏᴛᴇᴄᴛᴇᴅ ѕᴏụʀᴄᴇ ѕᴘᴇᴇᴅ](t.me/sourceSpeed)⦒
╚━━━━━━━━ 𖣘 ━━━━━━━╝ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴅᴇʟᴀʀ ⌁ ѕᴘᴇᴇᴅ˼',url="t.me/DeLaRALRsHaSH"},{text = '˹ᴅᴇᴍᴏɴ ⌁ ѕᴘᴇᴇᴅ˼', url="t.me/XxD_E_M_O_NxX"}},
{{text = '˹ᴛᴀʜᴀ ⌁ ᴏsᴋᴀʀ ま˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹ᴊᴏɪɴ⌁ѕᴘᴇᴇᴅ˼', url="t.me/sourceSpeed"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴅᴇʟᴀʀ ⌁ ѕᴘᴇᴇᴅ˼',url="t.me/DeLaRALRsHaSH"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DeLaRALRsHaSH&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ديمون'  then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ᴅᴇᴍᴏɴ ⌁ ѕᴘᴇᴇᴅ˼',url="t.me/XxD_E_M_O_NxX"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XxD_E_M_O_NxX&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local iduser = userid 
send(msg.chat_id_, msg.id_,'  𖢵 الايدي ↚ 「'..iduser..'」\n 𖢵 المعرف ↚ 「'..username..'」\n 𖢵 الرتبه ↚ 「'..rtp..'」\n 𖢵 نوع الكشف ↚ بالمعرف') 
end,nil) 
else 
...
if text == 'العاب سـبيد' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖢵  اهلا في قائمه الالعاب المتطوره سورس سـبيد 𖢵  
...
if tonumber(result.sender_user_id_) == tonumber(1773380350) then  
send(msg.chat_id_, msg.id_, " 𖢵  لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1777864253) then  
send(msg.chat_id_, msg.id_, " 𖢵  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n 𖢵  الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'sourceSpeed')..')'
...
if result.id_ == tonumber(1773380350) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1777864253) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n 𖢵  الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'sourceSpeed')..')'
status  = '\n 𖢵  تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1773380350) then  
send(msg.chat_id_, msg.id_, " 𖢵  لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1777864253) then  
send(msg.chat_id_, msg.id_, " 𖢵  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if Get_info then
local TextS = "\n 𖢵  اهلا بك في متجر ملفات سـبيد\n 𖢵  ملفات السورس ↓\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐\n 𖢵  علامة تعني { ✔️ } ملف مفعل\n 𖢵  علامة تعني { ✖ } ملف معطل\n 𖢵  قناة سورس سـبيد↓\n".." 𖢵  [اضغط هنا لدخول](t.me/sourceSpeed) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖢵  عذرا الملف لايدعم سورس سـبيد\n") 
end
return false
end
...
if text == ("مسح قائمه سـبيد") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖢵  تم مسح قائمه سـبيد')
return false
end

if text == 'قائمه سـبيد' and Sudo(msg) then
...
if #list == 0 then
t = " 𖢵  لا يوجد احد في قائمه سـبيد"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع سـبيد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سـبيد@(.*)$") and Sudo(msg) then
local username = text:match("^رفع سـبيد@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سـبيد(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سـبيد(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل سـبيد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سـبيد@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سـبيد@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سـبيد(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سـبيد(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, ' 𖢵  تم مسح جميع المعرصين')
end
if text == ("تاك للمعرصين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖢵  قائمة معرصين الجروب \n⧬━┅┅┄⟞❲[𝙎𝙋𝙀𝙀𝘿](t.me/sourceSpeed)❳⟝┄┉┉━⧬\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖢵  تم رفع الـعـضو  معرص في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵  الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖢵  تم تنزيل الـعـضو  معرص في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
' }\n'..' 𖢵   الرفع  ↚ { '..setadd..
' }\n'..' 𖢵   الحظر  ↚ { '..banm..' }\n\n 𖢵 𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐\n 𖢵  قناة سورس سـبيد↓\n [ ❲[𝐒𝐏𝐄𝐄𝐃](t.me/sourceSpeed)❳](t.me/sourceSpeed) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐\nاضغط علي الاسم ليتم نسخه\n𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐ٴ\n 𖢵  ❲[𝐒𝐏𝐄𝐄𝐃 ❈ ](t.me/sourceSpeed)❳ 𖢵  ')
end
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,' 𖢵 تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سـبيد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سـبيد')
local BANDA_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
send(msg.chat_id_, msg.id_," 𖢵 تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_,' 𖢵 لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖢵 قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖢵  الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..') '
status  = '\n 𖢵  الايدي  ↚ '..result.sender_user_id_..'\n 𖢵 تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,' 𖢵 وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,' 𖢵 لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖢵 صلاحيات البوت هي\n𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐\n 𖢵   علامة ال {✔️} تعني مفعل\n 𖢵   علامة ال {✖} تعني غير مفعل\n𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐\n 𖢵 تغير معلومات المجموعة ↞ '..INf..'\n 𖢵 مسح الرسائل ↞ '..DEL..'\n 𖢵 حظر المستخدمين ↞ '..REs..'\n 𖢵 دعوة المستخدمين ↞ '..INv..'\n 𖢵 ثتبيت الرسالة ↞ '..Pin..'\n 𖢵 اضافة مشرفين ↞ '..PRo)   
end
end
...
end --الكود حصري سورس سـبيديعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n 𖢵 المستخدم ~ ["..User_id .."] يصيح المشرفين \n𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐\n"
k = 0
...
return send(msg.chat_id_, msg.id_," 𖢵 ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_," 𖢵 ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖢵 تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖢵 تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سـبيد').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_," 𖢵 تـم تـفعـيل انا مين") 
return false  
end
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢵 انا مين معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_, msg.id_," 𖢵 تـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/sourceSpeed)')
return false
end
...
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢵 معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🌚♥️](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/sourceSpeed)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🌚💕](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/sourceSpeed)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🌚💕](t.me/sourceSpeed)')
return false
end
end
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢵 اكتب تفعيل نسبه جمالي") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖢵 نسبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان 🌚💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
{
{text = '˹𝐣𝐨𝐢𝐧⌁??𝐨𝐨𝐧˼', url="t.me/sourceSpeed"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_," 𖢵 تـم تـفعـيل مريم") 
return false  
end
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢵 مريم  معطله") 
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
local Teext =[[
 𖢵 مرحب بيك في اوامر الوضع واضف 𖢵 
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐 
 𖢵 اوامر الوضع - اضف
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
 𖢵 اضف / مسح ← رد
...
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
 ...
 𖢵 امسح
 𖢵 صلاحيه
 𖢵 قائمه منع المتحركات
 𖢵 قائمه منع الصور
 𖢵 قائمه منع الملصقات
 𖢵 مسح قائمه المنع
 𖢵 المحذوفين
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
 𖢵 مسح  امر + الامر القديم  
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
 𖢵 الاوامر المضافه ( لعرض الاوامر المضافه ) 
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
❲[𝐒𝐏𝐄𝐄𝐃 ❈ ](t.me/sourceSpeed)❳ 
]]
keyboard = {} 
...
local Teext =[[
 𖢵 مرحب بيك في اوامر تنزيل ورفع 𖢵 
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐 
 𖢵 اوامر تنزيل ورفع
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐 
 𖢵 مميز
...
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
 𖢵 اوامر التغير …
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
 𖢵 تغير رد المطور + اسم
 𖢵 تغير رد المالك + اسم
 𖢵 تغير رد منشئ الاساسي + اسم
 𖢵 تغير رد المنشئ + اسم
 𖢵 تغير رد المدير + اسم
 𖢵 تغير رد الادمن + اسم
 𖢵 تغير رد المميز + اسم
 𖢵 تغير رد الـعـضو  + اسم
 𖢵 تغير امر الاوامر
 𖢵 تغير امر م1 ~ الئ م10
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐 
 𖢵 اوامر المجموعه 📢 .
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
 𖢵 استعاده الاوامر 
 𖢵 تحويل كالاتي⇜ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
 𖢵 صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
 𖢵 كشف القيود
 𖢵 تعين الايدي
 𖢵 تغير الايدي
 𖢵 الحساب + ايدي الحساب
 𖢵 مسح + العدد
 𖢵 تنزيل الكل
 𖢵 تنزيل جميع الرتب
 𖢵 منع + برد
┇~ الصور + متحركه + ملصق ~
 𖢵 حظر ~ كتم ~ تقيد ~ طرد
 𖢵 المحظورين ~ المكتومين ~ المقيدين
 𖢵 الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
 𖢵 تقيد ~ كتم + الرقم + ساعه
 𖢵 تقيد ~ كتم + الرقم + يوم
 𖢵 تقيد ~ كتم + الرقم + دقيقه
 𖢵 تثبيت ~ الغاء تثبيت
 𖢵 الترحيب
 𖢵 الغاء تثبيت الكل
 𖢵 كشف البوتات
 𖢵 الصلاحيات
 𖢵 كشف ~ برد ← بمعرف ← ايدي
 𖢵 تاك للكل
 𖢵 وضع لقب + لقب
 𖢵 مسح لقب بالرد
 𖢵 اعدادات المجموعه
...
local Teext =[[
 𖢵 مرحب بيك في اوامر للمطورين 𖢵 
اوامر المطورين ⇊
❲المطرو❳  ⇊
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
 𖢵 تفعيل ← تعطيل 
 𖢵 المجموعات ← المشتركين ← الاحصائيات
 𖢵 رفع ← تنزيل منشئ اساسي
 𖢵 مسح الاساسين ← المنشئين الاساسين
 𖢵 مسح المنشئين ← المنشئين
 𖢵 اسم ~ ايدي + بوت غادر 
 𖢵 اذاعه 
𖣐━━━━━𖠱 𝙎𝙋𝙀𝙀𝘿 𖠱━━━━━𖣐
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/sourceSpeed/41"},{text = 'لعبه الرياضيات',url="https://t.me/sourceSpeed/48"}},   
{{text = 'لعبه المختلف', url="https://t.me/sourceSpeed/42"},{text = 'لعبه السمايلات', url="https://t.me/sourceSpeed/49"}}, 
{{text = 'لعبه التخمين', url="https://t.me/sourceSpeed/43"},{text = 'لعبه العكس', url="https://t.me/sourceSpeed/50"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/sourceSpeed/44"},{text = 'لعبه الانكليزي', url="https://t.me/sourceSpeed/51"}}, 
{{text = 'لعبه حزوره', url="https://t.me/sourceSpeed/45"},{text = 'لعبه المعاني', url="https://t.me/sourceSpeed/52"}}, 
{{text = 'لعبه الامثله', url="https://t.me/sourceSpeed/46"},{text = 'عقاب', url="https://t.me/sourceSpeed/53"}},
{{text = 'مريم', url="https://t.me/sourceSpeed/47"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '˹ᴊᴏɪɴ⌁ѕᴘᴇᴇᴅ˼', url="t.me/sourceSpeed"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Teext =[[
𖣘 بك في مميزات سورس سـبـيد𖣘 
𖣘 مميزات الخاصه بسورس𖣘 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', url="https://t.me/sourceSpeed/16"},{text = 'كتبات',url="https://t.me/sourceSpeed/21"}},   
{{text = 'انصحني', url="https://t.me/sourceSpeed/17"},{text = 'لو خيروك', url="https://t.me/sourceSpeed/18"}}, 
{{text = 'الصراحه', url="https://t.me/sourceSpeed/27"},{text = 'حروف', url="https://t.me/sourceSpeed/19"}}, 
{{text = 'رزله', url="https://t.me/sourceSpeed/22"},{text = 'رد عليه يابوت', url="https://t.me/sourceSpeed/26"}}, 
{{text = 'بتكره دا', url="https://t.me/sourceSpeed/23"},{text = 'نكته', url="https://t.me/sourceSpeed/20"}}, 
{{text = 'غنيلي', url="https://t.me/sourceSpeed/24"}},
{{text = 'نسبه جمالي', url="https://t.me/sourceSpeed/28"},{text = 'اليتيوب', url="https://t.me/sourceSpeed/29"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '˹ᴊᴏɪɴ⌁ѕᴘᴇᴇᴅ˼', url="t.me/sourceSpeed"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سـبيد')
